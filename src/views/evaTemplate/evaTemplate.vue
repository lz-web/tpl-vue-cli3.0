<template>
  <div id="evaTemplate" class="evaTemplate-wrap hui-container">
    <div class="header-wrap">
      ...
      <div class="time flex-content-between">
        <span>{{eva_detail.create_at | dateFilter}}</span>
    ...
    <br>
    <br>
    <div class="detail-c" ref="class">
      <div
        v-for="(item,i) in medical_type_all"
        :key="i"
        class="detail-item"
        :ref="`${item.en}`"
        :id="`${item.en}`"
...
<script lang="ts" src="./evaTemplate.ts"></script>

<style lang="scss">
@import "./evaTemplate.scss";
</style>
