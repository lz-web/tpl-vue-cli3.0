<template>
	<div class="adminEvaResult-wrap hui-container">
		...
		<!-- pdf 下載 -->
		<adminEvaTemplate v-show="is_show_pdf" :is_download="is_download"></adminEvaTemplate>
	</div>
</template>

<script lang="ts" src="./adminEvaResult.ts"></script>

<style lang="scss">
  	@import './adminEvaResult.scss';
</style>
